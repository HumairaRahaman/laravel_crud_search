                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="{{ route('products.create') }}" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Create Product</a>
...
{{--                    <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Reports</a>--}}
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 flex items-center justify-center font-semibold text-4xl sm:px-6 lg:px-8">
                <h1>products</h1>
            </div>
        </header>
        <main>
